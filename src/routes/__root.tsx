...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Premium fitness essentials for your everyday journey. Resistance bands, yoga mats, shaker bottles, ab rollers and more." },
      { property: "og:title", content: "Cartveda — Everything Fitness. One Cart." },
      { property: "og:description", content: "Premium fitness essentials for your everyday journey." },
